...
src/
├── components/
│   ├── AddExpenseModal    — модалка создания новой траты
│   ├── BalanceCard        — карточка баланса с СБП-ссылкой
│   ├── CategoryFilter     — фильтр + кастомные категории с wiggle-редактированием
...
│   ├── Toast              — уведомления с прогресс-баром и undo
│   └── TransactionList    — список трат со свайп-жестами и inline-редактированием
├── hooks/
